...
GRAV_GITHUB_PROJECTS=(grav \
               grav-learn \
               grav-skeleton-blog-site grav-skeleton-shop-site grav-skeleton-onepage-site grav-skeleton-hpstr-site grav-skeleton-mediator-site grav-skeleton-notepad-site grav-skeleton-agency-site grav-skeleton-deliver-site grav-skeleton-twenty-site \
               grav-theme-antimatter grav-theme-bootstrap grav-theme-afterburner2 grav-theme-hpstr grav-theme-mediator grav-theme-notepad grav-theme-agency grav-theme-deliver grav-theme-twenty \
