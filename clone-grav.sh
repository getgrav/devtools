...
GRAV_GITHUB_PROJECTS=(grav \
               grav-learn \
               grav-skeleton-blog-site grav-skeleton-shop-site grav-skeleton-onepage-site grav-skeleton-hpstr-site \
               grav-theme-antimatter grav-theme-bootstrap grav-theme-afterburner2 grav-theme-hpstr \
