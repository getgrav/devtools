...
GRAV_GITHUB_PROJECTS=(grav \
               ...
               grav-plugin-problems grav-plugin-sitemap grav-plugin-error grav-plugin-taxonomylist grav-plugin-simplesearch grav-plugin-random grav-plugin-pagination grav-plugin-feed grav-plugin-breadcrumbs grav-plugin-lightslider grav-plugin-snipcart grav-plugin-twigcache grav-plugin-github grav-plugin-archives
               )
